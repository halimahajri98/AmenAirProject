...
public class Controlling extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDevice = b.getParcelable(connectionBluetooth.DEVICE_EXTRA);
        mDeviceUUID = UUID.fromString(b.getString(connectionBluetooth.DEVICE_UUID));
        mMaxChars = b.getInt(connectionBluetooth.BUFFER_SIZE);
